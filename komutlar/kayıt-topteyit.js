...
if(!message.member.roles.cache.some(r => ['817820784390963231'].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))return message.reply("Bu Komutu Kullanmak İçin Yetkiniz Bulunmamakta.")  
...
exports.conf = {
    enabled: true,
    guildOnly: false,
    aliases: ["topteyit", "ktop", "teyit", "top-teyit"],
    permLevel: 0
};
